      ...
      <section style={{ borderBottom: '1px solid var(--line)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
            {[
              { cat: 'Developer', items: ['JSON Formatter & Validator', 'Base64 Encoder / Decoder', 'Regex Tester con cheatsheet'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg> },
              { cat: 'Seguridad', items: ['Password Generator seguro', 'JWT Decoder & Validator', 'URL Encoder / Decoder'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> },
              { cat: 'Productividad', items: ['Pomodoro Timer', 'Quick Notes con auto-save', 'Focus Mode con pantalla completa'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> },
              { cat: 'Imagen & QR', items: ['Comprimir PNG / JPG / WebP', 'Generador de códigos QR', 'Vista previa en tiempo real'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg> },
              { cat: 'Color & Diseño', items: ['HEX / RGB / HSL / OKLCH', 'Match automático a Tailwind', 'Presets de colores populares'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="19" cy="13" r="2.5"/><circle cx="6" cy="12" r="2.5"/><circle cx="10" cy="20" r="2.5"/></svg> },
              { cat: 'Texto & Más', items: ['Markdown Previewer', 'UUID Generator', 'Unit Converter con CSS/px'], icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/></svg> },
            ].map((block) => (
