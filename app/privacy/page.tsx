    ...
    <section>
      <div className="container" style={{ maxWidth: 760 }}>
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--paper-mute)', marginTop: 16 }}>Última actualización: Mayo 2026</p>
        </div>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.75, color: 'var(--paper-dim)' }} className="a-content">
          ...
          <p><strong>Contacto directo:</strong> Si nos escribís por email o WhatsApp, usaremos tu información únicamente para responderte. No la compartiremos con terceros.</p>
          ...
          <p>Para ejercer cualquiera de estos derechos, contáctanos en <a href="mailto:GaloDevcr@gmail.com" style={{ color: 'var(--lime)' }}>GaloDevcr@gmail.com</a>.</p>
          ...
          <p><strong>Email:</strong> <a href="mailto:GaloDevcr@gmail.com" style={{ color: 'var(--lime)' }}>GaloDevcr@gmail.com</a></p>
